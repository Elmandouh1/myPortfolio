...
export const Banner = () => {
  ...
  const toRotate = [ "Software Engineer Student" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Khaled`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer Student" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <button onClick={() => window.location.href = "#footer"}>Let’s Connect <ArrowRightCircle size={25} /></button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
